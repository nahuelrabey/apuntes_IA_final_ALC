...
Esta identidad se utiliza como paso intermedio en la demostración de que $\det(B(\omega)) = (1-\omega)^n$ para el método SOR. Ver [contexto completo](../finales/Examen_2026_02_18/01_metodo_sor/teoria.md#inciso-b-determinante-de-iteracion-y-condicion-de-rango-cota).
